    ...
    return <div className="admin-header">
        <div className="container-fluid">
            <div className="row">
                ...
                <div className="col-auto"><h1 className="page-title">{`${professionalAdmin_data.firstName}  ${professionalAdmin_data.lastName}`}</h1>
                    <p className="card-text">CEO</p>
                </div>
                <div className="col-auto ms-auto">
                    <Link href="/professional-admin/edit"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
