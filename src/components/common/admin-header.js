...
//   useEffect(() => {
//     // if (roles == "ROLE_PROFESSIONAL_ADMIN")
//       dispatch(professionalAdminProfileDetails());
//     // if (roles == "ROLE_PROFESSIONAL_MANAGER")
//     //   dispatch(professionalManagerDetails());
//   }, []);
//   const professionalAdmin_data = useSelector(
//     (state) => state.professionalAdminData.professionalAdminData
//   );
    ...
    <div className="admin-header">
      <div className="container-fluid">
        <div className="row">
          ...
          <div className="col-auto">
            <h1 className="page-title">{`${professionalAdmin_data.firstName}  ${professionalAdmin_data.lastName}`}</h1>
            <p className="card-text">CEO</p>
          </div>
          <div className="col-auto ms-auto">
            <Link href="/professional-admin/edit">
              <svg
                width="25"
                height="25"
                viewBox="0 0 25 25"
